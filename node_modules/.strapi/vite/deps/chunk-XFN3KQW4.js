import {
  ...
  StageColumn,
  getDisplayName
} from "./chunk-P43C2OUI.js";
import {
  buildValidParams as buildValidParams2
} from "./chunk-AK5CFNWL.js";
import {
  getStageColorByHex
} from "./chunk-UDPSGQUT.js";
import {
  LimitsModal
} from "./chunk-2JGNN6GK.js";
import {
...
} from "./chunk-PLDRKPDB.js";
import {
  useTypedSelector
} from "./chunk-YXCGT7SS.js";
import {
  ...
  useGetLocalesQuery,
  useGetSettingsQuery
} from "./chunk-6MYGCMON.js";
import {
  ReleaseActionMenu,
  ReleaseActionOptions
} from "./chunk-YYDCZ7X6.js";
import {
  index
} from "./chunk-AMBMASIU.js";
import {
...
import {
  ...
  usePersistentState,
  useSelectionState
} from "./chunk-J44JPLIR.js";
import {
  useConfig,
  useTracking
} from "./chunk-WHSGT6VG.js";
import {
  AssetSource,
  AssetType,
...
import {
  useDocumentActions
} from "./chunk-UEDTQJHX.js";
import {
  buildValidParams,
  useContentManagerContext,
  useDocument,
  useDocumentLayout
} from "./chunk-Q6CROMLY.js";
import {
  renderAdmin
} from "./chunk-GG6ELMSW.js";
import {
  useAIAvailability
} from "./chunk-C6GWWVUR.js";
import {
  useLicenseLimits
} from "./chunk-MH5AOTNI.js";
import {
  Table,
  useTable
} from "./chunk-JYWEIXU2.js";
import {
  useField,
  useForm
...
var index2 = {
  register(app) {
    ...
    app.addMenuLink({
      ...
      Component: () => import("./App-B365TG6I.js"),
      position: 5
    });
    app.registerPlugin({
      id: pluginId,
  ...
  register(app) {
    app.createSettingSection({
    ...
    }, [
      {
        ...
        id: "settings",
        to: "email",
        Component: () => import("./Settings-QAFOKCNL.js").then((mod) => ({
...
var admin2 = {
  register(app) {
    app.addMenuLink({
      ...
      Component: () => import("./App-CQYCOX3R.js").then((mod) => ({
        default: mod.Upload
      })),
      position: 4
    });
    app.addSettingsLink("global", {
      ...
      async Component() {
        const { ProtectedSettingsPage } = await import("./SettingsPage-M3KKVCYH.js");
        return {
...
var index3 = {
  ...
  bootstrap(app) {
    ...
    app.addSettingsLink("global", {
      ...
      Component: () => import("./SettingsPage-SBUWEWM4.js").then((mod) => ({
        default: mod.ProtectedSettingsPage
      })),
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled("cms-content-releases")) {
      app.addMenuLink({
        ...
        Component: () => import("./App-NTDQB5WU.js").then((mod) => ({
          default: mod.App
        })),
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { ProtectedReleasesSettingsPage } = await import("./ReleasesSettingsPage-6MQP22XC.js");
          return {
      ...
      app.widgets.register([
        {
          ...
          component: async () => {
            const { UpcomingReleasesWidget } = await import("./Widgets-ZAHWJO2F.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseContentReleases } = await import("./PurchaseContentReleases-UHTXI2PT.js");
          return {
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled(FEATURE_ID)) {
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { Router } = await import("./router-FIWQXAPC.js");
          return {
            default: Router
          };
        }
      ...
      app.widgets.register((widgets) => [
        ...widgets,
        {
          ...
          component: async () => {
            const { AssignedWidget } = await import("./Widgets-NQ3LMP42.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseReviewWorkflows } = await import("./purchase-review-workflows-M7MUEKHY.js");
          return {
...
//# sourceMappingURL=chunk-XFN3KQW4.js.map
