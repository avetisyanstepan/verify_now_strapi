import {
  ...
  QueryClientProvider,
  img
} from "./chunk-T4X5X5XJ.js";
import {
  ADMIN_PERMISSIONS_CE,
  HOOKS
} from "./chunk-JJWJS23J.js";
import {
  useNpsSurveySettings
} from "./chunk-NWXUCP27.js";
import {
  GuidedTourContext,
  useAIAvailability
} from "./chunk-C6GWWVUR.js";
import {
  useGetAIUsageQuery
} from "./chunk-KRNN4KBO.js";
import {
  require_pick
} from "./chunk-JN7UBSIU.js";
import {
  getBasename
} from "./chunk-QIJGNK42.js";
import {
  useClipboard
} from "./chunk-KUHRM44C.js";
import {
  useEnterprise
} from "./chunk-NL5AB7MY.js";
import {
  ADMIN_PERMISSIONS_EE,
  AUDIT_LOGS_DEFAULT_PAGE_SIZE,
  getEERoutes
} from "./chunk-VFHYBDQT.js";
import {
  Login
} from "./chunk-VQSIIDNQ.js";
import {
  MemoizedInputRenderer
} from "./chunk-5WNJESLA.js";
import {
  Form
} from "./chunk-LR73XVPV.js";
import {
  Column,
  LayoutContent,
  Logo,
  UnauthenticatedLayout
} from "./chunk-TDXQSM77.js";
import {
  ConfigurationProvider
} from "./chunk-ECSHBH5F.js";
import {
  require_baseMerge,
  require_createAssigner,
  require_merge,
  require_omit
} from "./chunk-PMZQ6GPS.js";
import {
  require_baseRest
} from "./chunk-MI64TBEY.js";
import {
  HistoryProvider
} from "./chunk-SZPZADP7.js";
import {
  errorsTrads
...
import {
  ...
  create4 as create2,
  create6 as create3
} from "./chunk-CDPVDFUN.js";
import {
  Layouts
} from "./chunk-UD2WO7HX.js";
import {
  TrackingProvider,
  useTracking
} from "./chunk-V5U63J7A.js";
import {
  createAbsoluteUrl,
  useInitQuery
} from "./chunk-TTFGEBQ4.js";
import {
  getByteSize
...
} from "./chunk-4KGE3CCQ.js";
import {
  useTypedDispatch,
  useTypedSelector,
  useTypedStore
} from "./chunk-L5J7TOSU.js";
import {
  NotificationsProvider,
  useNotification
} from "./chunk-NELVFCRX.js";
import {
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.AUDIT_LOGS) ? [
    {
      path: "audit-logs",
      lazy: async () => {
        const { ProtectedListPage } = await import("./ListPage-ZLDNDCYM.js");
        return {
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.SSO) ? [
    {
      path: "single-sign-on",
      lazy: async () => {
        const { ProtectedSSO } = await import("./SingleSignOnPage-OY4MN3F3.js");
        return {
...
var AuthPage = () => {
  ...
  const { hasAdmin } = data ?? {};
  const Login$1 = useEnterprise(Login, async () => (await import("./Login-MU5P6LF5.js")).LoginEE);
  const forms = useEnterprise(FORMS, async () => (await import("./constants-IC2MDU3K.js")).FORMS, {
...
var ROUTES_CE = [
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-JISAHWWE.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-4FFOX3AW.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-3VEHWLUO.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-QOJZWHLS.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-KA2PSOM4.js");
      return {
        Component: ProtectedEditPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-KFDIN5G3.js");
      return {
        Component: ProtectedCreatePage
      };
    },
  ...
  {
    lazy: async () => {
      const editWebhook = await import("./EditPage-LKJZIFLW.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-XD6BNZYE.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-CIGKFDOZ.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-YHIPTVPE.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditViewPage-MBJT2D6N.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-YCCKB7QH.js");
      return {
        Component: ProtectedCreateView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-FLLM4HMV.js");
      return {
        Component: ProtectedListView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditView-4HSSFSW2.js");
      return {
        Component: ProtectedEditView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedInstalledPlugins } = await import("./InstalledPlugins-4B43MLZN.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseAuditLogs } = await import("./PurchaseAuditLogs-6XLWLEHR.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseSingleSignOn } = await import("./PurchaseSingleSignOn-AQD237TB.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseContentHistory } = await import("./PurchaseContentHistory-2DJJZLSC.js");
      return {
...
var getImmutableRoutes = () => [
  {
    path: "usecase",
    lazy: async () => {
      const { PrivateUseCasePage } = await import("./UseCasePage-OFGR5CWS.js");
      return {
...
var getInitialRoutes = () => [
  {
    index: true,
    lazy: async () => {
      const { HomePage } = await import("./HomePage-IWJ6KIW2.js");
      return {
        Component: HomePage
      };
    }
  },
  {
    path: "me",
    lazy: async () => {
      const { ProfilePage } = await import("./ProfilePage-KPBKRFHI.js");
      return {
  ...
  },
  {
    path: "marketplace",
    lazy: async () => {
      const { ProtectedMarketplacePage } = await import("./MarketplacePage-USKJLDDJ.js");
      return {
  ...
  },
  {
    path: "settings/*",
    lazy: async () => {
      const { Layout } = await import("./Layout-FDVFTC4T.js");
      return {
        Component: Layout
      };
    },
    children: [
      {
        ...
        lazy: async () => {
          const { ApplicationInfoPage } = await import("./ApplicationInfoPage-TBJ5QDTN.js");
          return {
    ...
    const routes = [
      {
        ...
        children: [
          ...getImmutableRoutes(),
          {
            path: "/*",
            lazy: async () => {
              const { PrivateAdminLayout } = await import("./AuthenticatedLayout-GQNGL5J2.js");
              return {
    ...
    this.widgets.register([
      {
        ...
        component: async () => {
          const { ProfileWidget } = await import("./Widgets-2CJEABIJ.js");
      ...
      },
      {
        ...
        component: async () => {
          const { KeyStatisticsWidget } = await import("./Widgets-2CJEABIJ.js");
      ...
      this.widgets.register([
        {
          ...
          component: async () => {
            const { AuditLogsWidget } = await import("./Widgets-U74G7UR6.js");
...
//# sourceMappingURL=chunk-GG6ELMSW.js.map
